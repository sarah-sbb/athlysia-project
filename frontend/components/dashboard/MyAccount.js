...
function MyAccountWidget() {
  ...
  return (
    <div>
      ...
      <ul>
        <li className={styles.listItem}>Admins : <span style={{fontWeight: "bold"}}>{nbAdmins}</span>/4</li>
        <li className={styles.listItem}>Gestionnaires : <span style={{fontWeight: "bold"}}>{nbGestionnaires}</span>/10</li>
        <li className={styles.listItem}>Viewers : <span style={{fontWeight: "bold"}}>{nbViewers}</span>/50</li>
      </ul>
      <p>
